            ...
            child: Column(
              ...
              children: [
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ListView.builder(
                          shrinkWrap:
                              true, // tells Flutter to take only the needed space
                          physics:
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Row(
                                      mainAxisSize: MainAxisSize
                                          .min, // prevent Row from expanding full width
                                      children: [
                                        Icon(
                                          Icons.access_time,
                                          color: Colors.black,
                                    ...
                                    Row(
                                      ...
                                      mainAxisSize: MainAxisSize
                                          .min, // so row only takes needed width
                                      children: const [
                                        Text(
                                          'Cleaning',
                                          style: TextStyle(
                                    ...
                                    const SizedBox(
                                        height:
                                            20), // increased from 19 to 30 for more space
                ...
                Container(
                  ...
                  padding:
                      const EdgeInsets.all(10), // same padding on all sides
                        ...
                        Center(
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment
                                .start, // prevent Row from expanding full width
                            children: const [
                              SizedBox(
