...
class JobDoneOneSp extends StatefulWidget {
  const JobDoneOneSp({Key? key}) : super(key: key);

  @override
  State<JobDoneOneSp> createState() => _JobDoneOneState();
}

class _JobDoneOneState extends State<JobDoneOneSp> {
  late String jobId;
  Timer? _timer;
                ...
                return Container(
                  ...
                  child: Text(
                    value
                        ...
                        : 'The Customer refused a request for confirmation that the work was completed.',
